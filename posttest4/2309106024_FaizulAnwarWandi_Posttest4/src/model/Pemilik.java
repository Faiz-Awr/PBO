...
public class Pemilik {
    ...
    public static void tambahPemilik() {
        ...
        if (email.trim().isEmpty()) {
            tambahPemilik(id, nama, alamat, noTelp); 
        } else {
            tambahPemilik(id, nama, alamat, noTelp, email);
        }
    }

    public static void tambahPemilik(int id, String nama, String alamat, String noTelp) {
        pemilikList.add(new Pemilik(id, nama, alamat, noTelp, "N/A")); 
        System.out.println("Data pemilik berhasil ditambahkan dengan email default!");
    }

    public static void tambahPemilik(int id, String nama, String alamat, String noTelp, String email) {
