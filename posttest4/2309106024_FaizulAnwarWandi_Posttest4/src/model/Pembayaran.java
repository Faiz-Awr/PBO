...
public class Pembayaran {
    ...
    public void setIdPembayaran(int id_pembayaran) {
        this.id_pembayaran = id_pembayaran;
    }
    ...
    public void setTotalBiaya(double total_biaya) {
        this.total_biaya = total_biaya;
    }
    ...
    public static void updatePembayaran() {
        ...
        for (Pembayaran pembayaran : pembayaranList) {
            if (pembayaran.getIdPembayaran() == id_pembayaran) {
                System.out.print("ID Kunjungan Baru: ");
                pembayaran.setIdKunjungan(input.nextInt());
                input.nextLine();
                System.out.print("Total Biaya Baru: ");
                pembayaran.setTotalBiaya(input.nextDouble());
                input.nextLine();
                System.out.print("Metode Pembayaran Baru: ");
                pembayaran.setMetodePembayaran(input.nextLine());
    ...
    public static void hapusPembayaran() {
        ...
        boolean removed = pembayaranList.removeIf(pembayaran -> pembayaran.getIdPembayaran() == id_pembayaran);
        if (removed) {
