...
public class Jadwal {
    ...
    public static void updateJadwal() {
        ...
        for (Jadwal jadwal : jadwalList) {
            if (jadwal.id_jadwal == id_jadwal) {
                ...
                jadwal.id_hewan = input.nextInt();
                input.nextLine();
                System.out.print("No Lisensi Baru: ");
                jadwal.no_lisensi = input.nextLine();
                System.out.print("Tanggal dan Waktu Baru: ");
                jadwal.tanggal_waktu = input.nextLine();
    ...
    public static void hapusJadwal() {
        ...
        boolean removed = jadwalList.removeIf(jadwal -> jadwal.id_jadwal == id_jadwal);
        if (removed) {
