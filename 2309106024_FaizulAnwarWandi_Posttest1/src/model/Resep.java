...
public class Resep {
    ...
    public static void updateResep() {
        ...
        for (Resep resep : resepList) {
            if (resep.id_resep == id_resep) {
                System.out.print("ID Kunjungan Baru: ");
                resep.id_kunjungan = input.nextInt();
                input.nextLine();
                System.out.print("Nama Obat Baru: ");
                resep.nama_obat = input.nextLine();
                System.out.print("Dosis Baru: ");
                resep.dosis = input.nextLine();
    ...
    public static void hapusResep() {
        ...
        boolean removed = resepList.removeIf(resep -> resep.id_resep == id_resep);
        if (removed) {
