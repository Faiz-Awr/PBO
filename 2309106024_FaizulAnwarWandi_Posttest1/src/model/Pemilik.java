...
public class Pemilik {
    ...
    public static void updatePemilik() {
        ...
        for (Pemilik pemilik : pemilikList) {
            if (pemilik.id == id) {
                ...
                pemilik.nama = input.nextLine();
                System.out.print("Alamat Baru: ");
                pemilik.alamat = input.nextLine();
                System.out.print("No Telp Baru: ");
                pemilik.noTelp = input.nextLine();
                System.out.print("Email Baru: ");
                pemilik.email = input.nextLine();
    ...
    public static void hapusPemilik() {
        ...
        boolean removed = pemilikList.removeIf(pemilik -> pemilik.id == id);
        if (removed) {
