...
public class Stok {
    ...
    public void setIdStok(int id_stok) {
        this.id_stok = id_stok;
    }
    ...
    public static void updateStok() {
        ...
        for (Stok stok : stokList) {
            if (stok.getIdStok() == id_stok) {
                System.out.print("ID Obat Baru: ");
                stok.setIdObat(input.nextInt());
                input.nextLine();
                System.out.print("Jumlah Stok Baru: ");
                stok.setJumlahStok(input.nextInt());
                input.nextLine();
                System.out.print("Kadaluarsa Baru: ");
                stok.setKadaluarsa(input.nextLine());
    ...
    public static void hapusStok() {
        ...
        boolean removed = stokList.removeIf(stok -> stok.getIdStok() == id_stok);
        if (removed) {
