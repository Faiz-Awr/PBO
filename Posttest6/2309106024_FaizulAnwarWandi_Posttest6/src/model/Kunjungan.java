...
public class Kunjungan {
    ...
    public void setTanggalKunjungan(String tanggal_kunjungan) {
        this.tanggal_kunjungan = tanggal_kunjungan;
    }
    ...
    public static void updateKunjungan() {
        ...
        for (Kunjungan kunjungan : kunjunganList) {
            if (kunjungan.getIdKunjungan() == id_kunjungan) {
                System.out.print("ID Hewan Baru: ");
                kunjungan.setIdHewan(input.nextInt());
                input.nextLine();
                System.out.print("No Lisensi Baru: ");
                kunjungan.setNoLisensi(input.nextLine());
                System.out.print("Tanggal Kunjungan Baru: ");
                kunjungan.setTanggalKunjungan(input.nextLine());
                System.out.print("Keluhan Baru: ");
                kunjungan.setKeluhan(input.nextLine());
                System.out.print("Diagnosa Baru: ");
                kunjungan.setDiagnosa(input.nextLine());
                System.out.print("Tindakan Baru: ");
                kunjungan.setTindakan(input.nextLine());
    ...
    public static void hapusKunjungan() {
        ...
        boolean removed = kunjunganList.removeIf(kunjungan -> kunjungan.getIdKunjungan() == id_kunjungan);
        if (removed) {
